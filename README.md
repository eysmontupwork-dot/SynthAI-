SynthAI — AI автомобільний діагностичний стенд
███████╗██╗   ██╗███╗   ██╗████████╗██╗  ██╗ █████╗ ██╗
██╔════╝╚██╗ ██╔╝████╗  ██║╚══██╔══╝██║  ██║██╔══██╗██║
███████╗ ╚████╔╝ ██╔██╗ ██║   ██║   ███████║███████║██║
╚════██║  ╚██╔╝  ██║╚██╗██║   ██║   ██╔══██║██╔══██║██║
...
Офлайн — автоматично перемикається на локальну модель Ollama без інтернетуgemma3:12b
---
...
AI онлайн	Погугліть Gemini 2.5 Flash
AI офлайн	Оллама + Джемма 3 12B
OBD	ELM327 через Bluetooth (/dev/rfcomm0)
TTS	Edge TTS (uk-UA-PolinaNeural)
STT	Розпізнавання мови + Google API
...
API ключі Gemini (безкоштовно на aistudio.google.com)
...
⚠️ **Ніколи не комітьте у репозиторій.** Файл вже доданий до ..env.gitignore
...
Як користуватись
Перша діагностика
Підключіть OBD адаптер до роз'єму авто (під рулем)
Переконайтесь що Bluetooth з'єднання активне
В чаті напишіть марку і модель авто, наприклад:
*"Ford Focus 2015"*

IRIS автоматично підбере PID коди для цього авто
Запитайте діагностику:
